...
def send_to(sdef, data, slen=SLEN):
    # sdef.setblocking(1)
    print(sdef,data)
...
if "Linux" in platform.system():
    ...
    def receive(slen=SLEN, timeout=LTIMEOUT):
        conn ,sdef,addr= node.set_port()
        sdef.setblocking(1)
        ...
        if True:
            try:
                ...
                data = int(conn.recv(slen))  # receive length
        ...
        return json.loads(segments),addr
